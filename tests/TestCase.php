...
namespace JeffersonGoncalves\FilamentCommerce\Region\Tests;
...
use JeffersonGoncalves\FilamentCommerce\Region\FilamentCommerceRegionServiceProvider;
use JeffersonGoncalves\FilamentCommerce\Region\Tests\Fixtures\TestPanelProvider;
use JeffersonGoncalves\FilamentCommerce\Region\Tests\Fixtures\TestUser;
...
abstract class TestCase extends CommerceFilamentTestCase
{
    ...
    protected function getPackageProviders($app): array
    {
        return [
            ...
            FilamentCommerceRegionServiceProvider::class,
